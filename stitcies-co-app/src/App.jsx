...
function App() {
  ...
  return (
    <div style={{width: '1728px', height: '6321px', background: '#FAF8F8'}}>
        ...
        <footer style={{width:'100%',background:'#82001A',color:'white',padding:'2rem 5%',display:'flex',flexWrap:'wrap',justifyContent:'space-between',alignItems:'flex-start',position:'relative',boxSizing:'border-box',minHeight:'10rem'}}>
